...
public class ProjectActivityStep extends TestBase {
	...
	public void clicks_on_Generate_Project_Activities() throws Throwable {
		...
		TestUtilDemo.isElementPresent(ProjectActivityOBJ.selectApplicableWBSCriteriaModelTitle, "");
		Thread.sleep(3000);
	...
	public void adding_new_row_for_project_activity(String activityName) throws Throwable {
		TestUtilDemo.clickElement(ProjectActivityOBJ.formProjectActivity, "click on form");
		TestUtilDemo.scrollDownForShort();
		TestUtilDemo.clickElement(ProjectActivityOBJ.addRowButton, " addRowButton Link");
		Thread.sleep(3000);
