...
public class ProjectInfoOBJ extends TestBase {
	...
	public static By PROJECTSELECTIONTesting = By.xpath("//div[@class='card-body']/p[text()='045736']");
	...
	public static By PerformanceResponsibility =By.name ("generalScopeData.performanceResponsibilityAndGuaranteesByBlack&Veatch");
	public static By SupplierInvoice = By.xpath ("//p[text()='Supplier/Subcontractor Invoice Processing by Black & Veatch']//parent::div//input[@value='Yes']");
	...
	public static By unitSystemDropDown= By.xpath ("//div[@class=' css-1wy0on6']/div");
	public static By unitSystemDropDownValue= By.xpath ("//div[text()='English Units']");
	public static By authorityHaving= By.name ("projectTechnicalData.authorityHavingJurisdiction");
	public static By CompanyLicenseRequired = By.xpath ("//p[text()='Company License Required in Border?']//parent::div//input[@value='Yes']");
	public static By stateRegCode = By.name ("projectTechnicalData.stateRegCode");
 ...
 //project Control
	public static By costTrackingSoftwareTB  = By.xpath ("//div[text()='Cost Tracking Software']//parent::div//input[@tabindex='0']");
	public static By staffingSoftware  = By.xpath ("//div[text()='Staffing Software']//parent::div//input[@tabindex='0']");

	//Procurements
	
	public static By materialTracking  = By.xpath ("//div[text()='Material Tracking Software']//parent::div//input[@tabindex='0']");
	...
	//Electrical
	public static By electricalSystemsAnalysisSoftwareTB = By.name ("software.electricalSystemsAnalysisSoftware");
	public static By powerSupplyRedundancyTB = By.name ("designBasis.powerSupplyRedundancy");
	public static By mediumVoltageValueKVTB = By.name ("designBasis.mediumVoltageValueKV");
	public static By electricalCheckedMark= By.xpath ("//p[text()='Electrical']//parent::li//img[@class='sideMenuIcon']");
		
	//IandC
	public static By instrumentDataTB = By.id ("react-select-2-input");
	public static By IandCCheckedMark= By.xpath ("//p[text()='I&C']//parent::li//img[@class='sideMenuIcon']");
	
	//Strctural
	public static By structuralSection= By.xpath ("//p[text()='Structural']");
	public static By buildingCodeDD= By.xpath ("//p[text()='Building Code']//parent::div//div[@class=' css-1wy0on6']/div");
	public static By buildingCodeDValue= By.xpath ("//div[text()=' Other']");
	public static By structuralModelingTB= By.xpath ("//div[text()='Structural Modeling Software ']//parent::div//input");
	public static By generalFoundationDD= By.xpath ("//p[text()='General Foundation Type ']//parent::div//div[@class=' css-1wy0on6']/div");
	public static By generalFoundationDValue= By.xpath ("//div[text()='Other']");
	public static By seismicSdsTB= By.name("siteSpecificDesignCodeCriteria.seismicSds(g)");
	public static By structuralCheckedMark= By.xpath ("//p[text()='Structural']//parent::li//img[@class='sideMenuIcon']");
