...
public class ReferenceLibraryOBJ extends TestBase {
	...
	//DPS Electrical Role
	public static By projectSpecificDocumentsElectricalCheckedMark= By.xpath ("//p[text()='Project-Specific Documents - Electrical']//parent::li//img[@class='sideMenuIcon']");
	public static By projectSpecificDocumentsElectrical= By.xpath ("//p[text()='Project-Specific Documents - Electrical']");
	public static By clientDocumentsElectrical= By.xpath ("//p[text()='Client Documents - Electrical']");
	public static By clientDocumentsElectricalCheckedMark= By.xpath ("//p[text()='Client Documents - Electrical']//parent::li//img[@class='sideMenuIcon']");
	public static By proceduresElectrical= By.xpath ("//p[text()='Procedures - Electrical']");
	public static By proceduresElectricalCheckedMark= By.xpath ("//p[text()='Procedures - Electrical']//parent::li//img[@class='sideMenuIcon']");
	public static By calculationTemplatesElectrical= By.xpath ("//p[text()='Calculation Templates - Electrical']");
	public static By calculationTemplatesElectricalCheckedMark= By.xpath ("//p[text()='Calculation Templates - Electrical']//parent::li//img[@class='sideMenuIcon']");
	public static By typicalDetailsElectrical= By.xpath ("//p[text()='Typical Details - Electrical']");
	public static By typicalDetailsElectricalCheckedMark= By.xpath ("//p[text()='Typical Details - Electrical']//parent::li//img[@class='sideMenuIcon']");
	public static By manualsHandbooksElectrical= By.xpath ("//p[text()='Manuals/Handbooks - Electrical']");
	public static By manualsHandbooksElectricalCheckedMark= By.xpath ("//p[text()='Manuals/Handbooks - Electrical']//parent::li//img[@class='sideMenuIcon']");
	public static By trainingElectrical= By.xpath ("//p[text()='Training - Electrical']");
	public static By trainingElectricalCheckedMark= By.xpath ("//p[text()='Training - Electrical']//parent::li//img[@class='sideMenuIcon']");
	public static By otherElectrical= By.xpath ("//p[text()='Other - Electrical']");
	public static By otherElectricalCheckedMark= By.xpath ("//p[text()='Other - Electrical']//parent::li//img[@class='sideMenuIcon']");
	public static By checklistsElectrical= By.xpath ("//p[text()='Checklists - Electrical']");
	public static By checklistsElectricalCheckedMark= By.xpath ("//p[text()='Checklists - Electrical']//parent::li//img[@class='sideMenuIcon']");
	
	//DPS I&C Role
		public static By projectSpecificDocumentsIandCCheckedMark= By.xpath ("//p[text()='Project-Specific Documents - I&C']//parent::li//img[@class='sideMenuIcon']");
		public static By projectSpecificDocumentsIandC= By.xpath ("//p[text()='Project-Specific Documents - I&C']");
		public static By clientDocumentsIandC= By.xpath ("//p[text()='Client Documents - I&C']");
		public static By clientDocumentsIandCCheckedMark= By.xpath ("//p[text()='Client Documents - I&C']//parent::li//img[@class='sideMenuIcon']");
		public static By proceduresIandC= By.xpath ("//p[text()='Procedures - I&C']");
		public static By proceduresIandCCheckedMark= By.xpath ("//p[text()='Procedures - I&C']//parent::li//img[@class='sideMenuIcon']");
		public static By calculationTemplatesIandC= By.xpath ("//p[text()='Calculation Templates - I&C']");
		public static By calculationTemplatesIandCCheckedMark= By.xpath ("//p[text()='Calculation Templates - I&C']//parent::li//img[@class='sideMenuIcon']");
		public static By typicalDetailsIandC= By.xpath ("//p[text()='Typical Details - I&C']");
		public static By typicalDetailsIandCCheckedMark= By.xpath ("//p[text()='Typical Details - I&C']//parent::li//img[@class='sideMenuIcon']");
		public static By manualsHandbooksIandC= By.xpath ("//p[text()='Manuals/Handbooks - I&C']");
		public static By manualsHandbooksIandCCheckedMark= By.xpath ("//p[text()='Manuals/Handbooks - I&C']//parent::li//img[@class='sideMenuIcon']");
		public static By trainingIandC= By.xpath ("//p[text()='Training - I&C']");
		public static By trainingIandCCheckedMark= By.xpath ("//p[text()='Training - I&C']//parent::li//img[@class='sideMenuIcon']");
		public static By otherIandC= By.xpath ("//p[text()='Other - I&C']");
		public static By otherIandCCheckedMark= By.xpath ("//p[text()='Other - I&C']//parent::li//img[@class='sideMenuIcon']");
		public static By checklistsIandC= By.xpath ("//p[text()='Checklists - I&C']");
		public static By checklistsIandCCheckedMark= By.xpath ("//p[text()='Checklists - I&C']//parent::li//img[@class='sideMenuIcon']");
		
		//DPS Structural Role
		public static By projectSpecificDocumentsStructuralCheckedMark= By.xpath ("//p[text()='Project-Specific Documents - Structural']//parent::li//img[@class='sideMenuIcon']");
		public static By projectSpecificDocumentsStructural= By.xpath ("//p[text()='Project-Specific Documents - Structural']");
		public static By clientDocumentsStructural= By.xpath ("//p[text()='Client Documents - Structural']");
		public static By clientDocumentsStructuralCheckedMark= By.xpath ("//p[text()='Client Documents - Structural']//parent::li//img[@class='sideMenuIcon']");
		public static By proceduresStructural= By.xpath ("//p[text()='Procedures - Structural']");
		public static By proceduresStructuralCheckedMark= By.xpath ("//p[text()='Procedures - Structural']//parent::li//img[@class='sideMenuIcon']");
		public static By calculationTemplatesStructural= By.xpath ("//p[text()='Calculation Templates - Structural']");
		public static By calculationTemplatesStructuralCheckedMark= By.xpath ("//p[text()='Calculation Templates - Structural']//parent::li//img[@class='sideMenuIcon']");
		public static By typicalDetailsStructural= By.xpath ("//p[text()='Typical Details - Structural']");
		public static By typicalDetailsStructuralCheckedMark= By.xpath ("//p[text()='Typical Details - Structural']//parent::li//img[@class='sideMenuIcon']");
		public static By manualsHandbooksStructural= By.xpath ("//p[text()='Manuals/Handbooks- Structural']");
		public static By manualsHandbooksStructuralCheckedMark= By.xpath ("//p[text()='Manuals/Handbooks- Structural']//parent::li//img[@class='sideMenuIcon']");
		public static By trainingStructural= By.xpath ("//p[text()='Training - Structural']");
		public static By trainingStructuralCheckedMark= By.xpath ("//p[text()='Training - Structural']//parent::li//img[@class='sideMenuIcon']");
		public static By otherStructural= By.xpath ("//p[text()='Other - Structural']");
		public static By otherStructuralCheckedMark= By.xpath ("//p[text()='Other - Structural']//parent::li//img[@class='sideMenuIcon']");
		public static By checklistsStructural= By.xpath ("//p[text()='Checklists - Structural']");
		public static By checklistsStructuralCheckedMark= By.xpath ("//p[text()='Checklists - Structural']//parent::li//img[@class='sideMenuIcon']");
