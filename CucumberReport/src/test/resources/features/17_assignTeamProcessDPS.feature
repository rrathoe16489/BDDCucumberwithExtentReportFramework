#Author: RameshRathod
Feature: Assign Discipline Team for process Role

  Scenario: Validate ProcesssEngineeringTeam Section : Select Roles and add professional name and Navigation
    ...
    Then validate user click on processsEngineeringTeam
  ...
  Scenario: Validate ProcessDesignTeam Section : Select Roles and add professional name and Navigation
