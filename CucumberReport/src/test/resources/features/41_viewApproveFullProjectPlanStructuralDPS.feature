#Author: RameshRathod
Feature: ViewApprove Full Project Plan as a DPS Structural Role
  ...
  Scenario Outline: Validate ViewApprove Full Project Plan
    ...
    Then Verify the Project Activity details when clicking ViewEdit Full Information in structural "<budgetManhoursHrs>"
